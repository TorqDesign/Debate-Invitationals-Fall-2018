  ...
  <?php require_once('includes/form_script.php'); ?>
    ...
    <header class="bg-primary text-white background">
      <div class="container text-center" style="position: relative; top: 50%; transform: translateY(-50%);">
      	<h1 id="tagline">a <span id="gradient1">city</span> of <span id="gradient2">innovation</span></h1>
	        		...
	        		<div class="row">
	        			<div class="col-lg-4 outline-rect vert-center">
	        				<div class="feature-txt">
					            ...
					            <p class=lead2>Even without any increase in Property Tax Rate (% or mil) the dollar amount of Property Tax is going to increase substantially due to increase in property prices in the last two years. Therefore, the taxes will cut into the available funds for families.</p>
					        </div>
				        </div>
	        		...
	        		<div class="row">
	        			<div class="col-lg-4 outline-rect vert-center">
	        				<div class="feature-txt">
					            ...
					            <p class="lead2">The City should develop a reputation as the most startup-friendly one in the region by providing office and working space at reasonable rates near the city center and through providing targeted support for those working on new ideas, projects, businesses and industries.</p>
					        </div>
				        </div>
				        <div class="col-lg-8 vert-center desktop-only">
	        		...
	        		<div class="row">
	        			<div class="col-lg-4 outline-rect vert-center">
	        				<div class="feature-txt">
					            ...
					            <p class="lead2">Many homes and businesses have suffered from the issue of sewage back up and flooding. This leads to issues of losses as well as problems of increased insurance charges.</p>
					        </div>
				        </div>
				        <div class="col-lg-8 vert-center desktop-only">
